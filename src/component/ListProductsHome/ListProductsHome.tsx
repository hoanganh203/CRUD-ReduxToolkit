...
const ListProductsHome = () => {
    ...
    return (
        ...
        <div>
            <div>
                <h2 className='text'>Sản Phẩm Mới </h2>
            </div>
            <div className="card_layout ">
                {data?.map((item: any) => {
                    return (
                        <div className="flex-wrap w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img
                            ...
                            <div className="px-5 pb-5">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    {Number(item.price).toLocaleString("vi-VN", { minimumFractionDigits: 3 })}
                                    </span>
                                    <a
                                        href="#"
